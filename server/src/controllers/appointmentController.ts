...
export class AppointmentController {
  static async scheduleAppointment(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      // Notify agent
      NotificationService.sendToUser(property.agentId.toString(), 'new_appointment', {
  ...
  static async updateAppointmentStatus(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      NotificationService.sendToUser(notifyUserId, 'appointment_status_updated', {
        appointmentId: appointment._id,
        status,
      });
